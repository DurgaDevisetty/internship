...
f = open(r"C:\Users\Hari D\Internship\lang_chain\naa\my_key.txt")
key = f.read()
...
#Loading Document
loader = PyPDFLoader(r"C:\Users\Hari D\Internship\lang_chain\naa\pdf.pdf")
...
db = Chroma.from_documents(chunks, embedding_model, persist_directory="./chromadb")
db.persist()
